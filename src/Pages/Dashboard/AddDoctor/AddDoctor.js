...
const AddDoctor = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch('https://doctors-portal-server-xi-flame.vercel.app/appointmentSpecialty')
        ...
        fetch(url, {
            ...
            .then(imgData => {
                if (imgData.success) {
                    ...
                    fetch('https://doctors-portal-server-xi-flame.vercel.app/doctors', {
                        method: 'POST',
                        headers: {
    ...
    return (
        <div className='w-96 p-7'>
            ...
            <form onSubmit={handleSubmit(handleAddDoctor)}>
                ...
                <input className='btn btn-accent w-full mt-8' type="submit" value='Add Doctor' />
